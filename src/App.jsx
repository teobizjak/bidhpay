...
<div className='text-white text-xl font-bold hidden md:block'>Scroll to learn more</div>
      ...
      <div className=' relative md:-mt-10 md:pt-36 pb-40 overflow-hidden'>
      ...
      <div className=' relative'>
        ...
        <div className='absolute top-0 left-0 w-full h-[100svh] bg-[url("./assets/image3.png")] bg-fixed bg-cover bg-center bg-no-repeat -z-40'></div>
        ...
        <img src={lineBottom} alt="Scroll Icon" className=" transform translate-y-1/2 w-full mx-auto absolute bottom-0 left-0 z-50" />
      </div>
      ...
      <div className='bg-[url("./assets/image5.png")] bg-cover bg-center bg-no-repeat pt-24 pb-36 relative inset-shadow-black'>
        <img src={lineTop} alt="Scroll Icon" className=" transform -translate-y-1/2 w-full mx-auto absolute top-0 left-0" />
